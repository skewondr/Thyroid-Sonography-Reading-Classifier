...
class Trainer:
    def __init__(self, config, model, optimizer, criterion, dataloader, model_dir):
        self.config = config
        self.model = model
        ...
        self.tester = Tester(self.config, self.model) #evaluation을 위한 클래스 호출 
    ...
    def train(self):
        for epoch in range(self.config.num_epochs):
            ...
            if self.tester.best_acc == self.tester.accs.avg:
                ...
                }, self.model_dir+'best_model/model.pth.tar')
